...
const choosePostingData = {
    ...
    category: [
        {img: projectIcon, title: 'Post a project', description: 'Recieve free quotes, best for when you have a specific idea, the project is not visual in nature or the project is complex.'},
        {img: contestIcon, title: 'Start a contest', description: 'Crowdsource ideas. Post a prize and get competing entries which you can iterate on with feedback. Great for visuals.'},
    ]
}
