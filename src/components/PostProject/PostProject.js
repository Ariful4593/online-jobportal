...
const PostProject = () => {
    ...
    return (
        <div className="container mt-5 project-area">
            <div className="row">
                <div className="col-12" style={{ margin: '0 auto', width: '800px' }}>
            ...
            <div className="row">
                <div className="col-12" style={{ margin: '0 auto', width: '800px' }}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <textarea rows="4" placeholder="Describe your project here..." cols="108" {...register("projectDescription", { required: true })} ></textarea>
